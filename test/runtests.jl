...
softsusy_spc = [SLHASpInfoBlock(Dict(1=>"SOFTSUSY",2=>"1.9.1")),
                ...
                SLHASMInputsBlock(Nullable{Float64}(),
                                Dict(1=>1.27934000e+02, 2=>1.16637000e-05,
                                       3=>1.17200000e-01, 4=>9.11876000e+01,
                                       5=>4.25000000e+00, 6=>1.74300000e+02,
                                       7=>1.77700000e+00)),
                SLHAMinParBlock(Nullable{Float64}(),
                                Dict(3=>1.00000000e+01, 4=>1.00000000e+00,
                                     1=>1.00000000e+02, 2=>2.50000000e+02,
                                     5=>-1.00000000e+02)),
				SLHAMassBlock(Nullable{Float64}(),
                                Dict( 24=>8.04191121e+01, 25=>1.10762378e+02,
                ...
                SLHAAlphaBlock(Nullable{Float64}(), -1.13732831e-01),
...
# $ wget http://skands.physics.monash.edu/slha/softsusy.spc -O-
slha = """
# SOFTSUSY1.9
...
"""
parsed = readslha(slha)
@test length(parsed) == 21
@test isnull(parsed[3].scale) == true
@test isnull(last(parsed).scale) == false
@test abs(last(parsed).scale.value -464.231969) < 1e-6
